...
class ActionGetPizzaTypes(Action):
	...
	def run(self, dispatcher, tracker, domain):
		...
		#pizza_types = ""
		pizza_type = tracker.get_slot("pizza_types")
		if pizza_type is None:
			pizza_types = "Carnivora, Pepperoni, Trentina, Ortolana, Caprese"
		elif pizza_type.lower() == "meat":
			pizza_types = "Carnivora, Pepperoni, Trentina"
		elif pizza_type.lower() == "vegetarian":
			pizza_types = "Ortolana, Caprese"
		else:
			pizza_types = "Carnivora, Pepperoni, Trentina, Ortolana, Caprese"

		return[SlotSet("pizza_types", pizza_types)]
